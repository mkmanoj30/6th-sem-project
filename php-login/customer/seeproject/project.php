...
$lastname=$_SESSION['lastname'];
    ...
    // insert query
    $query2 = "INSERT INTO `register` (
	`firstname`, `lastname`,`name`,`location`,`contact_number`, `email`) 
	VALUES (:creater_name,:lastname,:name,:location,:contact_number,:email)";
    ...
    $stmt1->bindParam(':creater_name', $this->creater_name);
	  $stmt1->bindParam(':lastname', $this->lastname);
	$stmt1->bindParam(':location', $this->location);
    $stmt1->bindParam(':contact_number', $this->contact_number);
    $stmt1->bindParam(':email', $this->email1);
